 ...
 * Desc :
 */
public class ScramblingInfoImgAdapter extends RecyclerView.Adapter<ScramblingInfoImgAdapter.ViewHolder> {

    ArrayList<String> data;
    Context context;
    private OnItemClickListener onItemClickListener;

    public ScramblingInfoImgAdapter(Context context, ArrayList<String> data) {
    ...
    @Override
    public void onBindViewHolder(@NonNull @NotNull ScramblingInfoImgAdapter.ViewHolder holder, int position) {
